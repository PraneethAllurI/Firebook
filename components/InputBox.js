        ...
        text-gray-500 font-medium mt-6">
            <div className="flex space-x-4 p-4 items-center">
                ...
                <form className="flex flex-1 ">
                    ...
                    {imageToPost && (
                        <div onClick={removePost} className="flex flex-col ml-2 filter
                    hover:brightness-110 transform hover:scale-105 cursor-pointer">
                            <img className="h-10 object-contain" src={imageToPost} alt="" />
                            <p className="text-xs text-red-500 text-center">Remove</p>
                        </div>
                    )}
                    <button className="p-2" type='submit' onClick={sendPost} >Submit</button>
                </form>
            </div>
